...
###########################################################################################################################
one<-function(t,tau,delta,lambda0,sigma2,pi){
...
two<-function(t,s,tau,delta,lambda0,sigma2,pi){
  # Censoring distribution
...
three<-function(t,s,tau,delta,lambda0,sigma2,pi){
  # Censoring distribution
  G_ts <- (1-t/tau)*(1-s/tau)
...
four<-function(t,s,tau,delta,lambda0,sigma2,pi){
  # Censoring distribution
  G_ts <- (1-t/tau)*(1-s/tau)
...
five<-function(t,s,tau,delta,lambda0,sigma2,pi){
  # Censoring distribution
  G_ts <- (1-t/tau)*(1-s/tau)
...
six<-function(t,s,tau,delta,lambda0,sigma2,pi){
  # Censoring distribution
  G_ts <- (1-t/tau)*(1-s/tau)
...
h<-function(t,tau,delta,lambda0,sigma2,pi){
  # Censoring distribution
  G_t <- (1-t/tau)
